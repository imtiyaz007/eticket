...
$name=$_POST['name'];
   ...
   $_SESSION['psgn']=$paseenger;
?>
<!DOCTYPE html>
<html >
<head>
  <meta charset="UTF-8">
  <title>angularjs-payment-form</title>
...
<body>
  ...
  <form ng-controller="PaymentFormCtrl" class="payment-form" name="paymentForm" method="POST" action="ticketcnf.php">
    ...
    <input type="text" class="card-input card-input--full" placeholder="Enter Card Number" ng-model="card.number" required card-number/>
    <input type="text" class="card-input card-input--full" placeholder="Enter Card Holder Name" ng-model="card.holder" card-holder required/>
    <div class="card-info clearfix">
      ...
      <div class="card-info__cvv">
        ...
        <input type="password" class="card-input card-input--cvv" placeholder="CVV" ng-model="card.cvv" card-cvv required/>
      </div>
    </div>
    <input type="submit"class="payment-form__button"  >
